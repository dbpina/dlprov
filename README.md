...
DLProv is a provenance-centric service to support Deep Learning (DL) life-cycle workflow analyses. DLProv captures provenance data during the execution and exports provenance graphs for DL model reproducibility. 
...
Here is a short video introducing DLProv, generated by Prof. Alvaro Coutinho using NotebookLM. The video provides an overview of the main ideas and motivations behind DLProv. 
...
The following softwares have to be configured/installed for running DLProv.

* [DfAnalyzer](https://github.com/dbpina/keras-prov/tree/main/DfAnalyzer): the open-source software for generic workflow provenance capture. 
* [dfa-lib-python](https://github.com/dbpina/keras-prov/tree/main/dfa-lib-python/) 
* [prov](https://pypi.org/project/prov/), [pydot](https://pypi.org/project/pydot/), and [provdbconnector](https://github.com/DLR-SC/prov-db-connector/tree/master/provdbconnector): W3C PROV compliant tools. 
* [MonetDB](http://www.monetdb.org/Documentation/UserGuide/Tutorial) and [pymonetdb](https://pypi.org/project/pymonetdb/): as the open-source column-store database system. (Please follow their user guide).
* [neo4j](https://neo4j.com) and [neo4j python](https://pypi.org/project/neo4j/): as the open-source graph database system to export and analyze the final provenance graph. (Please follow their user guide)
* [Java](https://java.com/pt-BR/): as the main programming language. (Please read the tutorials provided by Oracle Technology) 

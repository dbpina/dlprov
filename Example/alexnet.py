...
def load_dataset(t1):
    ...
    input_data_path_x = os.path.join(os.getcwd(), "data", "raw_images.npy")
    input_data_path_y = os.path.join(os.getcwd(), "data", "raw_labels.npy")
...
def split_data(x_data, y_data, t2):
    ...
    train_path_x = os.path.join(os.getcwd(), "preprocessed_data", "x_train.npy")
    train_path_y = os.path.join(os.getcwd(), "preprocessed_data", "y_train.npy")
    val_path_x = os.path.join(os.getcwd(), "preprocessed_data", "x_val.npy")
    val_path_y = os.path.join(os.getcwd(), "preprocessed_data", "y_val.npy")
    test_path_x = os.path.join(os.getcwd(), "preprocessed_data", "x_test.npy")
    test_path_y = os.path.join(os.getcwd(), "preprocessed_data", "y_test.npy")
...
def train_alexnet():
    ...
    t3 = Task(3, df, exec_tag, "Train", dependency = t2)
    ...
    t4 = Task(4, df, exec_tag, "Test", dependency = [t2,t3])  
    t4.begin()                 
...
def delete_json_resource(filename):
...
if __name__ == '__main__':
    ...
    delete_json_resource("dataset_pid.json")
    delete_json_resource("file_attrs.json")
    delete_json_resource("dataset_final.json")
